...
public class Issuing {
	...
	public Issuing(String docNo, String materialNumber, String postingDate, String refDocNo, String headerText, String idPlant, String idSloc, String movementType, int qty, String scanner) {
		this.docNo = docNo;
	...
	public Issuing(String docNo, String materialNumber, String postingDate, String refDocNo, String headerText, String idPlant, String idSloc, String movementType, String materialDesc, String ean, int qty, String scanner) {
		this.docNo = docNo;
		this.materialNumber = materialNumber;
		this.postingDate = postingDate;
		this.refDocNo = refDocNo;
